            ...
            <div className="App ">
                <Annotator
                    ...
                    asyncUpload={async (labeledData) => {
                        dataArray.fill(undefined).map(
                            (_, index) => ({
                                column1: symbolList[[labeledData.boxes[index].annotation]].getName(),
                                column2: symbolList[[labeledData.boxes[index].annotation]].getPrice(),
                                column3: symbolList[[labeledData.boxes[index].annotation]].getSymbolNum(),
                                column4: symbolList[[labeledData.boxes[index].annotation]].getPrice()* symbolList[[labeledData.boxes[index].annotation]].getSymbolNum(),
                                id: index,
                            }),
                        );
